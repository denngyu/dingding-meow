...
class FaceDetectionTests(unittest.TestCase):
    ...
    def test_profile_detection_uses_more_tolerant_parameters(self):
        ...
        self.assertEqual(kwargs["minNeighbors"], 4)
