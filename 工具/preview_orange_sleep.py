"""Preview the orange sleeping pose without camera, tray, or business-log access."""
...
def preview_tick(window):
    if not getattr(window, "_orange_sleep_preview_scheduled", False):
        window._orange_sleep_preview_scheduled = True
